...
(assert (ite (and (= statechart_drain_initial_1 true) (not statechart_fl_active_0)) (and (= block3true_2 true) (= block3false_2 false) (= statechart_drain_open_2 statechart_drain_open_1)) (and (= block3true_2 false) (= block3false_2 true) (= statechart_drain_open_2 statechart_drain_open_0))))
...
(assert (ite (and (= statechart_drain_initial_1 true) (not statechart_fl_active_0)) (and (= block3true_2 true) (= block3false_2 false) (= statechart_drain_open_4 statechart_drain_open_3)) (and (= block3true_2 false) (= block3false_2 true) (= statechart_drain_open_4 statechart_drain_open_2))))
(assert (or (and block3true_2
(not block3false_2))
(and (not block3true_2)
block3false_2)))
