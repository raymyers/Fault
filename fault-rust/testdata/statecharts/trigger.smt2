...
(assert (ite (and (= trigger_x_bar_0 true) (= trigger_fl_active_0 true)) (and (= block8true_0 true) (= block8false_0 false) (= trigger_fl_vault_value_6 trigger_fl_vault_value_5)) (and (= block8true_0 false) (= block8false_0 true) (= trigger_fl_vault_value_6 trigger_fl_vault_value_3))))
...
(assert (ite (and (= trigger_x_bash_0 true) (= trigger_fl_active_0 true)) (and (= block17true_0 true) (= block17false_0 false) (= trigger_x_foo_3 trigger_x_foo_2)) (and (= block17true_0 false) (= block17false_0 true) (= trigger_x_foo_3 trigger_x_foo_1))))
