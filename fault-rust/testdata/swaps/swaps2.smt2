...
(declare-fun swaps_s2_v_12 () Real)
...
(assert (= @__run_1 (and (= swaps_s2_v_6 swaps_s2_v_2) (= swaps_s2_v_6 swaps_s2_v_5))))
...
(assert (= @__run_1 (and (= swaps_s2_v_12 swaps_s2_v_8) (= swaps_s2_v_12 swaps_s2_v_11))))
(assert (or (and @__run_0 (not @__run_1)) (and (not @__run_0) @__run_1)))
